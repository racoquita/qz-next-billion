var App = function() {
	...
	this.off = function() {
		...
		$('.frame3').find('img.chart').attr('src', 'http://ads.quartz.cc/sponsors/house/next-billion/2014-05-20/mobile/images/f'+num+'-chart.png')
	...
	this.changeFrame = function() {
		if(num <= 6) {
			...
			for (var i = 4; i < 7; i++) {
				imgs[i] = 'http://ads.quartz.cc/sponsors/house/next-billion/2014-05-20/mobile/images/f'+i+'-chart.png';
			};
